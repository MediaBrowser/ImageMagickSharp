...
namespace ImageMagickSharp
{
	...
	internal static class DrawingWandInterop
	{
		...
		/// <param name="wand"> The wand. </param>
		[DllImport(Constants.WandLibrary, CallingConvention = Constants.WandCallingConvention)]
		internal static extern void DestroyDrawingWand(IntPtr wand);
		...
		[DllImport(Constants.WandLibrary, CallingConvention = Constants.WandCallingConvention)]
		internal static extern bool DrawComposite(IntPtr wand, int compose, double x, double y, double width, double height, IntPtr magickwand);
		...
		/// <summary> Draw set gravity. </summary>
		/// <param name="wand"> The wand. </param>
		...
		/// <summary> Draw set font size. </summary>
		/// <param name="wand"> The wand. </param>
		...
		/// <returns> An int. </returns>
		[DllImport(Constants.WandLibrary, CallingConvention = Constants.WandCallingConvention)]
		internal static extern FontWeightType DrawGetFontWeight(IntPtr wand);
		...
		/// <summary> Draw set font style. </summary>
		/// <param name="wand"> The wand. </param>
		...
		/// <summary> Draw get font resolution. </summary>
		/// <param name="wand"> The wand. </param>
		...
		/// <summary> Draw set font resolution. </summary>
		/// <param name="wand"> The wand. </param>
		/// <param name="x"> The x resolution. </param>
		/// <param name="y"> The y resolution. </param>
		[DllImport(Constants.WandLibrary, CallingConvention = Constants.WandCallingConvention)]
		internal static extern void DrawSetFontResolution(IntPtr wand, double x, double y);
